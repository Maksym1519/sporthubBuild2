...
const SignInForm = (props) => {
     ...
     const handleSubmit = async (e) => {
       ...
       try {
         ...
         const user = usersData.find((u) => u.attributes.email === formData.email && u.attributes.password === formData.password);
            ...
            <div className={s.inputs__wrapper}>
             <div className={s.input__wrapper}>
              ...
              <div className={s.input__wrapper}>
                ...
                <span className={s.forgotPassword__link} onClick={props.forgotPassword}><Text14500 text='Forgot password?' color='rgba(173, 121, 85, 1)'/></span>
                </div>
                <input
                  type="text"
                  className={s.input}
