    ...
    <div className={s.signIn__wrapper}>
      ...
      <div className={s.signIn__container}>
        ...
        <div className={s.signInForm__wrapper}>
          <InputForm
            title= {isMobile ? <Text32500 text="Sign up" /> : <Text36500 text="Sign up" />}
            marginBottom='49px'
            row={true}
            label={<Text14400 text="First Name" color="rgba(153, 153, 153, 1)" />}
            placeholder="Your First Name"
            row2={true}
            label2={<Text14400 text="Last Name" color="rgba(153, 153, 153, 1)" />}
            placeholder2="Your Last Name"
            row3={true}
            label3={<Text14400 text="Email" color="rgba(153, 153, 153, 1)" />}
            placeholder3="Your Email"
            rowEye2={true}
            reminder={true}
            button={true}
            buttonText={<Text16600 text='Sign up' />}
